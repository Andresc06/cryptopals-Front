            ...
            <main className={styles.container}>
                {walletUser ? 
                    <div className='card ms-3 text-white bg-dark p-3 border border-5'>
                        <span className='text-center d-flex fs-3 ms-4'>Your Wallet <RiWallet2Line className='fs-3 wallet mt-2 ms-2'/></span>
                    <p className='ms-2 mt-3'><strong className='text-success'>USDT:</strong> {walletUser.USD.toFixed(2)}</p>
                    <p className='ms-2'><strong className='text-info'>ETH:</strong> {walletUser.ETH.toFixed(2)}</p>
                    <p className='ms-2'><strong className='text-warning'>BNB:</strong> {walletUser.BNB.toFixed(2)}</p>
                    <p className='ms-2'><strong className='text-danger'>BUSD:</strong> {walletUser.BUS.toFixed(2)}</p>
                    </div>
                : ""}
